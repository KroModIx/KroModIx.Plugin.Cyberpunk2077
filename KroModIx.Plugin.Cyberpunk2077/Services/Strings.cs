...
public static class Strings
{
    ...
    private static readonly Dictionary<string, string> De = new()
    {
        ...
        ["tooltip.category_filter"] = "Client-side Kategorie-Filter (nur bereits geladene Mods)",
        ...
        ["btn.redmod_deploy"] = "⚙  REDmod deploy",
        ["dialog.redmod_deploy_title"] = "REDmod deploy?",
        ["dialog.redmod_deploy_msg"] = "REDmod-Deployment (redmod.exe deploy) wird ausgefuehrt — kann 30-90s dauern und aktualisiert final.redmod. Fortfahren?",
        ["dialog.redmod_deploy_ok"] = "Ausfuehren",
        ["notify.redmod_deploy_running"] = "REDmod-Deployment laeuft …",
        ["notify.redmod_deploy_ok"] = "REDmod-Deployment abgeschlossen.",
        ["notify.redmod_deploy_fail"] = "REDmod-Deployment fehlgeschlagen: ",
        ["notify.redmod_exe_missing"] = "redmod.exe nicht gefunden unter tools/redmod/bin/ — REDmod-DLC installiert?",
        ["notify.update_install_running"] = "Update wird installiert …",
        ["notify.update_install_ok"] = "Update installiert: ",
        ["notify.update_install_fail"] = "Update-Install fehlgeschlagen: ",
        ["btn.assign_nexus"] = "🔗  Nexus-Match zuweisen",
        ["dialog.nexus_match_title"] = "Nexus-Match zuweisen",
        ["dialog.nexus_match_header"] = "Fuer '{0}' die Nexus-Mod-URL oder Mod-ID einfuegen. Das speichert ein Install-Manifest — Cover, Beschreibung und Update-Check greifen ab dem naechsten Refresh.",
        ["dialog.nexus_match_placeholder"] = "https://www.nexusmods.com/cyberpunk2077/mods/12345  oder  12345",
        ["dialog.nexus_match_hint_ok"] = "✓ erkannte Mod-Id: {0}",
        ["dialog.nexus_match_hint_no"] = "Bitte eine gueltige Nexus-URL oder eine numerische Mod-Id eingeben.",
        ["dialog.nexus_match_ok"] = "Zuweisen",
        ["notify.nexus_match_saved"] = "Nexus-Match gespeichert (Mod-Id {0}) — Refresh startet.",
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["tooltip.category_filter"] = "Client-side category filter (only currently loaded mods)",
        ...
        ["btn.redmod_deploy"] = "⚙  REDmod deploy",
        ["dialog.redmod_deploy_title"] = "REDmod deploy?",
        ["dialog.redmod_deploy_msg"] = "REDmod deploy (redmod.exe deploy) will run — takes 30-90s and rebuilds final.redmod. Continue?",
        ["dialog.redmod_deploy_ok"] = "Run",
        ["notify.redmod_deploy_running"] = "REDmod deployment running …",
        ["notify.redmod_deploy_ok"] = "REDmod deployment finished.",
        ["notify.redmod_deploy_fail"] = "REDmod deployment failed: ",
        ["notify.redmod_exe_missing"] = "redmod.exe not found under tools/redmod/bin/ — REDmod DLC installed?",
        ["notify.update_install_running"] = "Installing update …",
        ["notify.update_install_ok"] = "Update installed: ",
        ["notify.update_install_fail"] = "Update install failed: ",
        ["btn.assign_nexus"] = "🔗  Assign Nexus match",
        ["dialog.nexus_match_title"] = "Assign Nexus match",
        ["dialog.nexus_match_header"] = "Paste the Nexus mod URL or mod-id for '{0}'. This stores an install manifest — cover, description and update check will work from the next refresh.",
        ["dialog.nexus_match_placeholder"] = "https://www.nexusmods.com/cyberpunk2077/mods/12345  or  12345",
        ["dialog.nexus_match_hint_ok"] = "✓ recognized mod-id: {0}",
        ["dialog.nexus_match_hint_no"] = "Enter a valid Nexus URL or numeric mod-id.",
        ["dialog.nexus_match_ok"] = "Assign",
        ["notify.nexus_match_saved"] = "Nexus match saved (mod-id {0}) — refreshing.",

...
/// <summary>Detail-Fenster für einen Cyberpunk-Nexus-Mod. Custom-Chrome
/// (Kroste-Standard: BorderOnly + ExtendClientAreaToDecorationsHint), Drag
/// per Titelleiste, Close-Button. Layout: großes Cover links, Titel + Meta +
/// Beschreibung rechts, KI-Zusammenfassung optional (auf Knopfdruck), Footer
/// mit „Nexus öffnen", „Herunterladen" (Premium), „KI-Zusammenfassung" und
/// „Schließen".</summary>
public sealed class NexusModDetailWindow : Window
{
    ...
    private Control BuildBody()
    {
        ...
        // v0.12.1: Rich-HTML-Rendering via _host.Descriptions.CreateRichView
        // (HtmlPanel) statt Plain-Text-TextBlock. Fallback wenn noch nicht
        // fertig geladen: kurzer Loading-TextBlock (Description enthaelt dann
        // den Plain-Text-Placeholder).
        ...
        var descCard = new Border
        {
            ...
            Child = new StackPanel { Children = { richHost, loadingFallback } },
        };
